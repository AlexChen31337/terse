---
name: alphastrike
description: "AlphaStrike v2 technical analysis and rule-based trading signal generator for BTC/ETH/SOL on Hyperliquid. Use when: (1) generating trading signals with RSI/MACD/EMA/Bollinger Bands, (2) checking signal confidence and indicator state for Hyperliquid perpetuals, (3) running automated signal generation workflows, (4) any mention of AlphaStrike, HL signals, or technical analysis for crypto perpetuals."
---
