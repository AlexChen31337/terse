---
name: simmer-risk
description: "Risk management framework for Simmer prediction market positions. Use when: (1) checking position guard status before any Simmer trade, (2) running risk checks against configured limits, (3) monitoring active positions for stop-loss/take-profit triggers, (4) generating daily risk reports, (5) any mention of Simmer risk, position guard, or prediction market risk management."
---
