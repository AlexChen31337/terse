...
**Claim code:** `leaf-7IPH`

## Setup

- **Credentials:** `~/.config/simmer/credentials.json` (chmod 600)
- **Python SDK:** `~/clawd/skills/simmer/.venv` (Python 3.11, simmer-sdk 0.8.26)
- **Run Python:** `~/clawd/skills/simmer/.venv/bin/python`
...
```python
import sys
sys.path.insert(0, '/home/bowen/clawd/skills/simmer/.venv/lib/python3.11/site-packages')
import json
from simmer_sdk import SimmerClient

creds = json.load(open('/home/bowen/.config/simmer/credentials.json'))
