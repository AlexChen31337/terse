...
```
cd /home/bowen/.openclaw/workspace && uv run --with httpx python skills/autoresearch/scripts/run.py --track devtools --dry-run
```
Result:
- Exit code: 0 ✅
...
- No personal info (Bowen's name, phone, email, Telegram ID) in any script ✅
