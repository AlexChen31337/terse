...
> synthesises a structured markdown report, and pings Bowen on Telegram.
...
3. If exit code 0 and stdout non-empty: send teaser to Bowen via Telegram
4. If exit code 1: send failure notice to Bowen
