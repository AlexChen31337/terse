...
description: >
  ...
  Pulls from arXiv, GitHub trending, Hacker News, and web search (Brave). Produces structured
  markdown reports in memory/ for Telegram notification and book draft integration.
author: Alex Chen
requires:
  - httpx (via uv run --with httpx)
optional:
  - BRAVE_API_KEY env var (for web narratives source)
---
