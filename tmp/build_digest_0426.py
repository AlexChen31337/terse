...
outpath = "/media/DATA/.openclaw/workspace/tmp/daily_ideas_20260426.html"
...
ann = abs(fr) * 3 * 365
oi_val = f"${top_fund.get('oi', 0):,.0f}"
fr_color = '#ef5350' if fr > 0 else '#4caf50'
...
{fa} funding at <b style="color:{fr_color};">{fr:+.4f}%</b> &mdash; {fc_text}. That is <b>{ann:.0f}% annualized</b> for delta-neutral funding collection.<br><br>
...
<b>Risk:</b> Weekend low liquidity = slippage risk. OI is {oi_val}. Funding can flip fast during vol spikes.
</div></div>
...
<div style="font-size:13px;color:#b0bec5;line-height:1.6;">
Sunday = peak CT engagement. BTC dom at <b>{btc_dom:.1f}%</b> = concentrated attention. A narrative thread can capture mindshare.<br><br>
<b>Thread (8-10 tweets):</b><br>
1. Hook: Every AI agent is a tenant on someone elses chain.<br>
